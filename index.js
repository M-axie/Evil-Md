const sessionName = "maxie";
const autobio = process.env.AUTOBIO || 'TRUE';
const owner = ["254716029292"];
const {
  default: maxieConnect,
...
if (autobio === 'TRUE'){ 
  ...
  client.ev.on("connection.update", async (update) => {
    ...
    if (connection === "close") {
      ...
      console.log(color("Type Menu for Evil's Command list", "green"));
